...
hidden_layer7 = Dense(10, activation = ac_hid_, 
                      kernel_regularizer = regularizers.l1_l2(0,0))
output_layer = Dense(3, activation = ac_out_, 
                      kernel_regularizer = regularizers.l1_l2(0,0))
...
with open('results/naive_class3_history20200513.pkl' , 'wb') as handle:
    pk.dump(history.history, handle, protocol=pk.HIGHEST_PROTOCOL)
with open('results/naive_class3_crossval20200513.pkl', 'wb') as handle:
    pk.dump(cross_val, handle, protocol=pk.HIGHEST_PROTOCOL)
model.model.save(r'results/naive_class3_model20200513.h5')
