...
# reads the training history. Useful for plotting the loss evolution during training      
with open(r"article_networks_nozeros\poly_reg\article['04']_crossval.pkl", 'rb') as handle:
    crossval04_clean = pk.load(handle)
with open(r"article_networks_nozeros\poly_reg\article['06']_crossval.pkl", 'rb') as handle:
    crossval06_clean = pk.load(handle)
with open(r"article_networks_nozeros\poly_reg\article['07']_crossval.pkl", 'rb') as handle:
    crossval07_clean = pk.load(handle)
with open(r"article_networks_nozeros\poly_reg\article['08']_crossval.pkl", 'rb') as handle:
    crossval08_clean = pk.load(handle)
with open(r"article_networks_nozeros\poly_reg\article['14']_crossval.pkl", 'rb') as handle:
